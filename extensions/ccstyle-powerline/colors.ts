...
// VS Code Modern Dark-inspired colors for the startup/editor chrome
...
const THEME = {
  sep: "#6a6a6a",         // Muted editor chrome
  model: "#3794ff",       // VS Code Modern Dark accent blue
  path: "#4ec9b0",        // Type/interface teal
  gitClean: "#89d185",    // Modern Dark success green
  accent: "#3794ff",      // VS Code focus blue
};
